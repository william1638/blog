...
<form class="form-group" action="" id="blog-form" method="post">
    <table class="table table-bordered table-striped table-hover table-condensed">
        ...
        <tr>
            <th>关键词</th>
            <td>
                <input class="form-control modal-sm" placeholder="多个关键词用顿号分隔" type="text" name="keywords" value="<?php echo str_replace(',','、',$data['keywords']);?>">
            </td>
        </tr>
        <tr>
            <th>描述</th>
        ...
        <tr>
            ...
            <td> <span class="inputword">是</span>
                <input class="icheck" type="radio" name="is_original" value="1" <?php if($data['is_original'] == 1): ?>checked="checked"<?php endif; ?> > <span class="inputword">否</span>
                <input class="icheck" type="radio" name="is_original" value="0" <?php if($data['is_original'] == 0): ?>checked="checked"<?php endif; ?> ></td>
        </tr>
        <tr>
            <th>是否置顶</th>
            <td> <span class="inputword">是</span>
                <input class="icheck" type="radio" name="is_top" value="1" <?php if($data['is_top'] == 1): ?>checked="checked"<?php endif; ?> > <span class="inputword">否</span>
                <input class="icheck" type="radio" name="is_top" value="0" <?php if($data['is_top'] == 0): ?>checked="checked"<?php endif; ?> ></td>
        </tr>
        <tr>
            <th>是否显示</th>
            <td> <span class="inputword">是</span>
                <input class="icheck" type="radio" name="is_show" value="1" <?php if($data['is_show'] == 1): ?>checked="checked"<?php endif; ?> > <span class="inputword">否</span>
                <input class="icheck" type="radio" name="is_show" value="0" <?php if($data['is_show'] == 0): ?>checked="checked"<?php endif; ?> ></td>
        </tr>
        <tr>
            <th></th>
            <td>
