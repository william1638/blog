...
<form action="" method="post" id="blog-form">
    <table class="table table-bordered table-hover" >
        ...
        <tr>
            <th>分类名</th>
            <td>
                <input class="form-control modal-sm" type="text" name="cname" value="<?php echo ($oneData["cname"]); ?>">
            </td>
        </tr>
        <tr>
            <th>所属栏目</th>
        ...
        <tr>
            <th>排序</th>
            <td>
                <input class="form-control modal-sm" type="text" name="sort" value="<?php echo ($oneData["sort"]); ?>">
            </td>
        </tr>
        <tr>
            <th>关键词</th>
            <td>
                <input class="form-control modal-sm" type="text" name="keywords" value="<?php echo ($oneData["keywords"]); ?>">
            </td>
        </tr>
        <tr>
            <th>描述</th>
